...
<section id="Team" class="py-24">
	...
	>
		<!-- description  -->
		<div class="flex flex-col justify-center w-3/4 lg:w-1/2 mx-auto">
			...
			<div class="bg-base-100 rounded-2xl p-12 shadow-lg relative mt-4">
				<Certificate
					class="w-12 h-12 p-2 rounded-2xl bg-primary text-white absolute -top-6 start-12 shadow-md"
				/>
				<h1 class="text-secondary font-semibold mb-4 text-base xl:text-lg">
				...
				{#each servicesExpectations as e}
					<div class="flex py-3 2xl:space-x-4 space-x-3">
						...
						<p class="font-medium text-base xl:text-lg">{e}</p>
					</div>
				{/each}
			</div>
		</div>
		<!-- founders photos  -->
		<div class="flex flex-row lg:w-1/2 w-3/4 mx-auto space-x-12 lg:space-x-0">
			<!-- qoussay photo  -->
			<div class="w-1/2">
